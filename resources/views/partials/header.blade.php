...
<link type="text/css" href="{{ url('css/vendor/material-icons.css') }}" rel="stylesheet">

<!-- Font Awesome Icons -->
<link type="text/css" href="{{ url('css/vendor/fontawesome.css') }}" rel="stylesheet">

<!-- App CSS -->
<link type="text/css" href="{{ url('css/app.css') }}" rel="stylesheet">

<!-- Toastr -->
<link type="text/css" href="{{ url('vendor/toastr.min.css') }}" rel="stylesheet">
