...
<!-- Quill Theme -->
<link type="text/css" href="{{ url('css/vendor/quill.css') }}" rel="stylesheet">

<!-- Dropzone -->
<link type="text/css" href="{{ url('css/vendor/dropzone.css') }}" rel="stylesheet">

<!-- Select2 -->
<link type="text/css" href="{{ url('vendor/select2/select2.min.css') }}" rel="stylesheet">
<link type="text/css" href="{{ url('css/vendor/select2.css') }}" rel="stylesheet">
@endsection
...
<!-- jQuery Mask Plugin -->
<script src="{{ url('vendor/jquery.mask.min.js') }}" defer></script>

<!-- Quill -->
<script src="{{ url('vendor/quill.min.js') }}" defer></script>
<script src="{{ url('js/quill.js') }}" defer></script>

<!-- Select2 -->
<script src="{{ url('vendor/select2/select2.min.js') }}" defer></script>
<script src="{{ url('js/select2.js') }}" defer></script>
@endsection