      ...
      <div class="card">
        ...
        <div class="card-body py-4">
          ...
          <div class="d-flex justify-content-between pb-1">
            ...
            <div>
              <strong>${{ $sale['min'] }}</strong> <span class="text-muted">/ ${{ $sale['max'] }}</span>
            </div>
          </div>
          <div class="progress {{ $loop->last ? '' : 'mb-3' }}" style="height: 8px;">
          ...
          <li class="list-group-item list-group-item-action py-2">
            <div class="row align-items-center">
              ...
              <div class="col-lg d-flex align-items-center text-md-right">
                <span class="ml-auto badge badge-outline-{{ $task['color'] }}">{{ $task['type'] }}</span>
                <span class="ml-2">{{ $task['date'] }}</span>
                <span class="avatar avatar-xs ml-2">
                  <img src="{{ $task['user_image'] }}" class="avatar-img rounded-circle" alt="">
                </span>
              </div>
            </div>
          </li>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 py-2">
          <div class="d-flex flex-column flex-xl-row align-items-center text-center text-xl-left align-items-xl-start">
            <a href=""><img class="img-fluid img-lg-150 img-xl-200 rounded mr-xl-3 mb-3 mb-xl-0" src="{{ $post['image'] }}" alt="Blog post image"></a>
            <div class="flex">
              <h5 class="card-title mb-1"><a href="" class="headings-color">{{ $post['title'] }}</a></h5>
              <p class="text-muted mb-2">
                <small class="mr-1"><a href="" class="text-muted">{{ $post['author'] }}</a></small>
...
@section('footer')
<!-- Global Settings -->
<script src="{{ url('js/settings.js') }}" defer></script>
...
<!-- Moment.js -->
<script src="{{ url('vendor/moment.min.js') }}" defer></script>
<script src="{{ url('vendor/moment-range.js') }}" defer></script>

<!-- Chart.js -->
<script src="{{ url('vendor/Chart.min.js') }}" defer></script>
<script src="{{ url('js/charts.js') }}" defer></script>
<script src="{{ url('js/chartjs-rounded-bar.js') }}" defer></script>

<!-- Chart.js Samples -->
<script src="{{ url('js/page.dashboard.js') }}" defer></script>
<script src="{{ url('js/progress-charts.js') }}" defer></script>
@endsection
