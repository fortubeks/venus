...
<div class="{{ $containerClass ?? 'container' }} page__container">
  <div class="card card-form">
    <form action="{{url('suppliers')}}" method="post" autocomplete="off">
    @csrf
    <div class="row no-gutters">
      <div class="col-lg-4 card-body">
        <p><strong class="headings-color">Basic Information</strong></p>
        <p class="text-muted">Add your supplier details.</p>
      </div>
      <div class="col-lg-8 card-form__body card-body">
        <div class="row">
          ...
          <div class="col">
            <div class="form-group">
              ...
              <input id="" name="contact_person_name" type="text" class="form-control @error('contact_person_name') is-invalid @enderror" placeholder="Name" value="{{ old('contact_person_name') }}">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <input id="phone" name="contact_person_phone" type="text" class="form-control @error('contact_person_phone') is-invalid @enderror" placeholder="phone" value="{{ old('contact_person_phone') }}">
            @include('alerts.error-feedback', ['field' => 'contact_person_phone'])
            </div>
          </div>
          <div class="col-md-6">
            <label for="opass">Address</label>
            <input id="email" type="text" name="adress" class="form-control" value="{{ old('address') }}">
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
    ...
    <div class="row no-gutters">
      ...
      <div class="col-lg-8 card-form__body card-body">
        ...
        <div class="form-group">
          ...
          <input id="email" type="text" name="bank_account_name" class="form-control" value="{{ old('bank_account_name') }}">
        </div>
        <div class="form-group">
          <label for="opass">Account Number</label>
          <input id="email" type="text" name="bank_account_no" class="form-control" value="{{ old('bank_account_no') }}">
        </div>
